...
Tuteur/tutrice enseignant(e) de l'équipe:: mailto:pascal.sotin@univ-tlse2.fr[PSO]
...
Dossier contenant des informations sur les différents domaines concernés par cette SAE : https://github.com/IUT-Blagnac/sae3-01-devapp-g2b-11/tree/master/assets[Assets]
...
- Version courante : https://github.com/IUT-Blagnac/sae3-01-devapp-g2b-11/releases/tag/v0.1[v0.1] (_Pre-release_)
- Lien vers la doc technique : https://github.com/IUT-Blagnac/sae3-01-devapp-g2b-11/blob/master/assets/Docs/doc-technique.adoc[Doc Technique]
- Lien vers la doc utilisateur : https://github.com/IUT-Blagnac/sae3-01-devapp-g2b-11/blob/master/assets/Docs/doc-utilisateur.adoc[Doc Utilisateur]
- Liste des https://github.com/IUT-Blagnac/sae3-01-devapp-g2b-11/issues[User Stories]  et % restant
